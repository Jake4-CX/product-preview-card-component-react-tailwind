...
export function Product() {
  ...
  return (
  <div className='w-2/4 bg-white rounded-lg absolute'>
    <div className='flex flex-col md:flex-row justify-between items-center overflow-hidden'>
      ...
      <div className='p-6 md:h-[30em]'>
        ...
        <p className='my-8 text-[#919197] text-[14px]'>A floral, solar and voluptuous interpreation composed by Olivier Polge,
